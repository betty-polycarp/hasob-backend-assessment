...
class BrokerStaffDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'dmo-savings-bond-module::pages.broker_staffs.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param  \App\Models\BrokerStaff  $model
     * @return Builder
     */
    public function query(BrokerStaff $model)
    {
    ...
    {
        return 'broker_staffs_datatable_'.time();
    }
}
