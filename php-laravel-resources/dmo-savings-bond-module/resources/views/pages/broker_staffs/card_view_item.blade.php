...
<div class="card">
    ...
    <div class="row g-0">
        ...
        <div class="col-md-9">
            <div class="card-body">
                @php
                    $detail_page_url = route('sb.brokerStaffs.show', $data_item->id);
                @endphp
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-auto"> 
                        <a data-toggle="tooltip" 
                            ...
                            class="btn-edit-mdl-brokerStaff-modal inline-block mr-5" href="#">
                        ...
                        <a data-toggle="tooltip" 
                            title="Delete" 
                            data-val='{{$data_item->id}}' 
                            class="btn-delete-mdl-brokerStaff-modal inline-block mr-5" href="#">
