...
<div class="card">
    ...
    <div class="row g-0">
        ...
        <div class="col-md-9">
            <div class="card-body">
                @php
                    $detail_page_url = route('sb.bids.show', $data_item->id);
                @endphp
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-auto"> 
                        <a data-toggle="tooltip" 
                            ...
                            class="btn-edit-mdl-bid-modal inline-block mr-5" href="#">
                        ...
                        <a data-toggle="tooltip" 
                            title="Delete" 
                            data-val='{{$data_item->id}}' 
                            class="btn-delete-mdl-bid-modal inline-block mr-5" href="#">
