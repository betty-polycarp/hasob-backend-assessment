...
<div id="div-broker_code" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('broker_code', null, ['id'=>'broker_code', 'class' => 'form-control']); ?>
...
<div id="div-broker_name" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('broker_name', null, ['id'=>'broker_name', 'class' => 'form-control']); ?>
...
<div id="div-total_price" class="row mb-3">
    ...
    <div class="col-sm-9">
        <?php echo Form::number('total_price', null, ['id'=>'total_price', 'class' => 'form-control','min' => 0,'max' => 100000000]); ?>
...
<div id="div-investor_email" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('investor_email', null, ['id'=>'investor_email', 'class' => 'form-control']); ?>
...
<div id="div-investor_telephone" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('investor_telephone', null, ['id'=>'investor_telephone', 'class' => 'form-control']); ?>
...
<div id="div-middle_name" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('middle_name', null, ['id'=>'middle_name', 'class' => 'form-control']); ?>
...
</div><?php /**PATH C:\Users\DocB\Desktop\workspace\dmo-savings-bond-module\src/../resources/views/pages/subscriptions/fields.blade.php ENDPATH**/ ?>