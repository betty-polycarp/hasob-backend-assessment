                        ...
                        <div class="col-lg-12 ma-10">
                            ...
                            <div id="div-show-txt-subscription-primary-id">
                                <div class="row">
                                    ...
                                    <?php echo $__env->make('dmo-savings-bond-module::pages.subscriptions.show_fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                            </div>
                            <div id="div-edit-txt-subscription-primary-id">
                                <div class="row">
                                    <div class="col-lg-10 ma-10">
                                    <?php echo $__env->make('dmo-savings-bond-module::pages.subscriptions.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', ".btn-show-mdl-subscription-modal", function(e) {
        ...
        $.get( "<?php echo e(route('sb-api.subscriptions.show','')); ?>/"+itemId).done(function( response ) {
    ...
    $(document).on('click', ".btn-delete-mdl-subscription-modal", function(e) {
        ...
        swal({
                ...
                if (isConfirm) {
                    ...
                    let endPointUrl = "<?php echo e(route('sb-api.subscriptions.destroy','')); ?>/"+itemId;
    ...
    $('#btn-save-mdl-subscription-modal').click(function(e) {
        ...
        let actionType = "POST";
        let endPointUrl = "<?php echo e(route('sb-api.subscriptions.store')); ?>";
        ...
        if (primaryId != "0"){
            actionType = "PUT";
            endPointUrl = "<?php echo e(route('sb-api.subscriptions.update','')); ?>/"+primaryId;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\DocB\Desktop\workspace\dmo-savings-bond-module\src/../resources/views/pages/subscriptions/modal.blade.php ENDPATH**/ ?>