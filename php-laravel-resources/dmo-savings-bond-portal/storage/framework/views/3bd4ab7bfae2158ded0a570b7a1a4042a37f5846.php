                        ...
                        <div class="col-lg-12 ma-10">
                            ...
                            <div id="div-show-txt-broker-primary-id">
                                <div class="row">
                                    ...
                                    <?php echo $__env->make('dmo-savings-bond-module::pages.brokers.show_fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                            </div>
                            <div id="div-edit-txt-broker-primary-id">
                                <div class="row">
                                    <div class="col-lg-10 ma-10">
                                    <?php echo $__env->make('dmo-savings-bond-module::pages.brokers.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', ".btn-show-mdl-broker-modal", function(e) {
        ...
        $.get( "<?php echo e(route('sb-api.brokers.show','')); ?>/"+itemId).done(function( response ) {
    ...
    $(document).on('click', ".btn-delete-mdl-broker-modal", function(e) {
        ...
        swal({
                ...
                if (isConfirm) {
                    ...
                    let endPointUrl = "<?php echo e(route('sb-api.brokers.destroy','')); ?>/"+itemId;
    ...
    $('#btn-save-mdl-broker-modal').click(function(e) {
        ...
        let actionType = "POST";
        let endPointUrl = "<?php echo e(route('sb-api.brokers.store')); ?>";
        ...
        if (primaryId != "0"){
            actionType = "PUT";
            endPointUrl = "<?php echo e(route('sb-api.brokers.update','')); ?>/"+primaryId;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\DocB\Desktop\workspace\dmo-savings-bond-module\src/../resources/views/pages/brokers/modal.blade.php ENDPATH**/ ?>