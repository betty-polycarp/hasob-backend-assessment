...
class PaymentDetailDeletedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('PaymentDetail deleted successfully')
                                ->markdown(
                                    'mail.paymentDetails.deleted',
